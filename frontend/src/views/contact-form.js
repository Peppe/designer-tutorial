...
<vaadin-form-layout style="width: 100%; height: 100%;">
 ...
 <vaadin-email-field label="Email" id="emailField"></vaadin-email-field>
 <vaadin-combo-box label="Company" id="companyField"></vaadin-combo-box>
 <vaadin-combo-box label="Status" id="statusField"></vaadin-combo-box>
 <vaadin-horizontal-layout theme="spacing">
  <vaadin-button theme="primary" id="saveButton">
    Save 
  </vaadin-button>
  <vaadin-button theme="error" id="deleteButton">
    Delete 
  </vaadin-button>
  <vaadin-button theme="tertiary" id="closeButton">
    Close 
  </vaadin-button>
